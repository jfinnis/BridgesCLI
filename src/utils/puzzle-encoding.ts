...
export const samplePuzzles: PuzzleData[] = [
    ...
    },
    {
        ...
        solution:
            '9x9:a1-a4=a3a.3=a4|b|1.|b#2-1||.|3=8=3-4|.2|a#1b#3.|4-3|3=4#.|#1-3|b#.1#b|3=a4.a4=a4-a1a',
    },
    {
        encoding: '9x9:2a5a6b2a.a1d1a2.3a2b1a2a.a4b8a4b.3g3.b3a3b2a.a2a1b3a3.1a3d2a.a3b4a3a2',
        solution:
    ...
    },
    {
        ...
        solution:
            '9x9:3-3=2c1.#3-c3a|.##2-a1#a|.4#|2=a8=4.#2|c#2|.4-5-a1##2.|a#1-a3#|.|a3-a2-3|.2-b2-3=3',
    },
    {
        encoding: '9x9:4a2b1b3.a2b3a3b.5a4b1c.h3.b5a4a5b.1h.c1b3a4.b2a3b2a.1b3b2a3',
        solution:
            '9x9:4=2b1-a3.#2=a3-3a#.5=4-a1#a#.|a|c#a3.|a5=4-5a|.1a#a|a#a|.b#1|a3-4.b2|3=a2#.1-a3-a2-3',
    },
    {
        encoding: '9x9:1a2a3a4a3.a2a4a4a2a.1c2d.a5a4a2b3.b3a8b3a.3b1d3.b1b3a3a.a2b2d.4b4a3b3',
        solution:
            '9x9:1-2-3=4=3.a2-4-4=2|.1|a#2|b|.|5=4#2-a3.|#3=8=a3|.3#|1#b|3.##1|#3=3#.#2a|2|b#.4=a4-3-a3',
    },
    {
        encoding: '9x9:a2b3a4a4.3a4b2a2a.a2a5b4b.5a4d3a.c2a3c.a2d2a4.b3b3a2a.a4a3b2a2.3a2a2b2a',
        solution:
            '9x9:a2=a3-4=4.3=4=a2|2#.|2=5=a4##.5=4|b|3#.#a#2-3||#.#2#b#2|4.##3-a3|2#.#4=3-a2|2.3-2-2-a2a',
    },
    {
        encoding: '9x9:1a1a4a3a2.a3a2a2a3a.2g3.a2b3b3a.3b4a3b6.a3b4b3a.2g3.a4a2a1a2a.3a2a3a3a3',
        solution:
            '9x9:1a1-4=3-2.|3-2|2=3|.2#a||b|3.|2a|3=a3#.3=a4-3=a6.a3-a4=a3#.2#b|b|3.#4=2|1-2|.3-2-3-3=3',
    },
    {
        encoding: '9x9:2a3a4a3a2.a2a2a2a1a.b1a3d.2d1b2.a3b8b4a.4b4d2.d3a2b.a1a4a1a1a.1a1a2a3a2',
        solution:
            '9x9:2-3=4=3-2.|2-2-2a1|.||1-3|a||.2|b#1a|2.|3=a8=a4|.4=a4#b|2.|b#3-2||.|1-4-1|1|.1a1-2-3-2',
    },
    {
        encoding: '9x9:3a4a3a2a2.a2c3a3a.2a1e2.a3b2a1b.4a2b2a1a.a1b2a5a4.b2b3c.3c1a2b.a2a3a3b3',
        solution:
            '9x9:3=4-3-2-2.|2|a|3=3|.2#1a||a|2.|3-a2|1||.4-2-a2|1|.#1-a2-5-4.#a2=a3#a#.3-b1|2a#.a2=3-3-a3',
    },
    {
        encoding: '9x9:2b4b5a4.b3b4a2a.f1b.1a2a3c4.a4a3a3a3a.2c4a5a4.b1f.a2a2b3b.3a5b4b3',
        solution:
            '9x9:2=a4=a5=4.b3=a4|2#.b|b#1##.1a2-3#a#4.|4=3#3-3#.2#a|4=5-4.|#1|b#a|.|2|2-a3a|.3=5=a4=a3',
    },
    {
        encoding: '9x9:4a3a3b3a.a1a3b3a2.4a2a2b2a.a1a1e.2a5a8a4a4.e2a2a.a3b3a2a6.1a2b2a1a.a4b4a2a3',
        solution:
            '9x9:4=3-3=a3a.#1-3-a3|2.4-2|2a#2#.|1|1#a#|#.2|5=8=4|4.||#a#2-2#.|3#a3|2=6.1#2a|2-1#.a4=a4-2-3',
    },
    {
        encoding: '9x9:2b5b4a2.a1e1a.d1a3b.a4a8a2a3a.3a1a3a3a3.a2a2a2a6a.b2a2d.a2e3a.4a3b1b2',
        solution:
            '9x9:2-a5=a4-2.|1a#b|1|.||a#1-3||.|4=8=2|3|.3|1#3=3#3.#2|2|2=6#.#|2-2b##.#2-d3#.4=3-a1b2',
    },
    {
        encoding: '9x9:3a1a1a3a3.a2a1e.b2a7a4b.3d2b5.a2b4a3b.h3.3a2a3a4b.a2a3a3b4.2a3d2a',
        solution:
            '9x9:3-1a1a3-3.#2-1|a#a#.#|2=7=4a#.3|b#2=a5.|2-a4-3a|.|e#a3.3-2-3=4a#.|2=3-3=a4.2-3=c2a',
    },
    {
        encoding: '9x9:1a3b3b3.a2g.2a3a1a2a6.a4a1a3a3a.b1a2c4.3d3a6a.a4b6a1a3.e1a2a.3a3a5a5a3',
        solution:
            '9x9:1-3-a3-a3.a2|b|b#.2#3-1|2=6.#4|1-3-3#.##1a2b#4.3#b#3=6#.|4=a6|1#3|.|c#1|2|.3=3-5=5=3',
    },
    {
        encoding:
        ...
        solution:
            '9x16:a3-2-5=2a.2#3-2#2-2.###a|3|a|.#2#a1|1a|.4-4-a4-a4.|3-a1|1a#.2#2=a5|a#.|4=4a#2-4.|b#2#b|.3-a5#3-2|.|a1##b|3.|a|#4-a2#.3-3#|a2a4.|1|2|a#a#.1|2-3-3a#.a2-b2-a3',
    },
    {
        encoding:
        ...
        solution:
            '9x16:a2-2-3=3a.2|2=4-1|2.#|b|2=3#.#3=a5-3=5.5=3a|2=3|.|2|a|b|2.|#3-4-a3|.|3|1|b||.2|1|4=3|2.|4-2|a|||.3#1-2a|3|.#5-2-a3#3.3#3-a1|##.|2#2b|3#.2-3#2=3|2.a2=6=3-2a',
    },
    {
        encoding:
            '9x16:2a3b2b2.a1b2d.2e1a3.b4a8b2a.2b1b2a4.e1c.1a1a4b2a.a3a2d2.2d3a3a.a5b5a2a4.c1e.3a2b2b3.a2b3a1b.4a4e3.d2b1a.3b4b2a3.',
        solution:
            '9x16:2-3-a2-a2.|1|a2c|.2||a#a1-3.||4=8=a2|.2||1#a2=4.||||#1b|.1|1|4|a2|.a3-2#|a#2.2|b#3-3|.#5=a5|2=4.##a1||b|.3#2||2-a3.|2#|3-1a|.4=4||c3.|b|2-a1#.3=a4-a2-3.',
    },
    {
        encoding:
        ...
        solution:
            '13x22:1-2-a2-a3-2-2.h|1-2|.3=a3-a3-3-1||.|3-b1|d|2.|#3-b4-a1a||.3##c|a2-a4|.##5-a2|a|b#3.###b||a|2-3#.3#4-1|1a1|1-5.|#|b3=b4b#.|3|3-b1a|b3.2||#a2=b4-1|.|||5=b2d|.2|1|3-3-3=5=4.|4-2#a|c|a|.3#b#a|3-a4a|.#4-a3a|#b#a2.3|a3=a3#b2a|.||a|c4=b2|.||1|1a2=a3-a4.|1|1|g#.2-2a3=a3-a2-3',
    },
    {
        encoding: '9x9:3b3b4a2.a2c1c.b1a4a2b.3d2b3.a2b5b1a.4b2a2b2.b1a3b2a.a1c2b1.2a3d3a',
        solution:
            '9x9:3-a3=a4-2.#2-b1|a|.#|1-4-2a|.3|b#2-a3.|2-a5|a1|.4=a2#2a|2.|a1-3|a2|.|1-b2a|1.2-3=c3a',
    },
    {
        encoding: '9x9:4b4b4a4.b1a1d.2b1d3.d2a2b.4a4b3b4.a4b4b2a.2a1c2a2.a2e1a.2a4a3a4a2',
        solution:
            '9x9:4=a4-a4=4.#a1|1a|a#.2a|1|a|a3.b|a2-2a|.4=4-a3=a4.#4=a4-a2|.2#1a|a2|2.a2|a|a#1|.2=4-3-4-2',
    },
    {
        encoding:
